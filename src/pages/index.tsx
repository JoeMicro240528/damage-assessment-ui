        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center">
            {sudanRegions.map((region, index) => (
              <Card
                key={index}
                className={`border-0 shadow-md w-full lg:w-[50%] ${
                  region.status === "high-priority"
                    ? `${
                        !isRTL
                          ? "border-r-4 border-r-[#D41111]"
                          : "border-l-4 border-l-[#D41111]"
                      } bg-[#D41111]/5`
                    : `${
                        !isRTL
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <Card
                key={index}
                className="text-center border-0 shadow-md hover:shadow-lg transition-shadow bg-[0 0% 100%]"
              >
                <CardHeader>
                  ...
                  <Badge
                    variant="secondary"
                    className="bg-[#0059B3]/10 text-[#0059B3]"
                  >
                    {t(member.roleKey)}
                  </Badge>
                </CardHeader>
