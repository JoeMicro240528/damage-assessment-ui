                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <h1 className={`text-4xl lg:text-5xl font-bold leading-tight ${isRTL ? 'text-left' : 'text-right'}`}>
                                {t('hero.title')}
                                <br />
                            ...
                            <p className={`text-xl text-[#898F9A] leading-relaxed ${isRTL ? 'text-left' : 'text-right'}`}>
                                {t('hero.description')}
                            </p>
                        </div>
                        ...
                        <div className={`flex items-center  justify-around text-sm text-[#898F9A] ${isRTL ? '' : 'space-x-reverse'}`}>
                    ...
                    <div className="relative">
                        <div className="relative rounded-2xl overflow-hidden shadow-elegant">
                            ...
                            <div className={`absolute bottom-4 ${isRTL ? 'left-4' : 'right-4'} text-white`}>
                                <p className="text-sm font-medium">
                                    {isRTL ? 'Satellite Imagery Analysis' : 'تحليل صور الأقمار الصناعية'}
                                </p>
                                <p className="text-xs opacity-90">
                                    {isRTL ? 'Blue Nile - Sudan' : 'النيل الأزرق - السودان'}
                                </p>
                            </div>
