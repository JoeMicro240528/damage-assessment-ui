            ...
            <div className="flex md:items-center md:flex-row flex-col justify-between">
                <div className={`flex justify-between mb-3 items-center md:space-x-4 ${isRTL ? 'md:space-x-reverse' : ''}`}>
                    <Button
                        ...
                        size="sm"
                        onClick={() => navigate('/')}
                        className={`flex items-center cursor-pointer hover:bg-[#0059B3] hover:text-white border border-border hover:transition-all hover:duration-300 hover:ease-in-out space-x-2 ${isRTL ? 'space-x-reverse' : ''}`}
                    >
